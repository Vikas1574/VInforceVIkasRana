...
export class CountryServiceProxy{
     ...
     * @return Success
     */
    getCountries(permission: string | undefined): Observable<CountryListDtoListResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCounteries(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCounteries(<any>response_);
                } catch (e) {
    ...
    protected processGetCounteries(response: HttpResponseBase): Observable<CountryListDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
