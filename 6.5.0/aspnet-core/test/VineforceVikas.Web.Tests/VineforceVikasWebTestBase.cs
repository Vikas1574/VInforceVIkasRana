...
{
    public abstract class VineforceVikasWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static VineforceVikasWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(VineforceVikasWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<VineforceVikasDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<VineforceVikasDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<VineforceVikasDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<VineforceVikasDbContext, Task<T>> func)
        {
            T result;
